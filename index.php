...
<head>
    ...
    <title>BOOKAHOLIC ADMIN | Login</title>
...
<body>
    ...
    <div class="row">
        <!-- <h4 class="center">BOOKAHOLIC</h4> -->
        <center><img src="Image/logo_alt.png" class="responsive-img" style="width:60%;"></center>
        ...
        <form action="" method="post" id="login_form">
            <div class="row z-depth-5" id="form_content">
                ...
                <!-- BUTTON -->
                <div class="col s12 input-field">
                    <input type="submit" name="login_btn" value="Login" class="btn-large #00c853 green accent-4 col s12">
                </div>
                <!-- PHP -->
                <div class="col s12 input-field">
